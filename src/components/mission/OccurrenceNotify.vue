<template>
  <q-card class="notify" style="" >

    <q-card-section class="q-ma-md" style="text-align: center; padding-top: 30px; padding-left: 50px; padding-right: 50px;">
      <b>Félicitation !!!</b> Votre occurence a été créée.
    </q-card-section>
